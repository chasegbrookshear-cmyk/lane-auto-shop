...
R1 AI always covers **1-1-1**. Start buffs the partner (self if solo). Medic faints into the partner; Scout faints into an adjacent lane. Front/back swap is free. **Wall Hurt** also pings one adjacent enemy front. Run is first to **3** wins before **3** losses.
